        ...
        while True:
            ...
            while True:
                ...
                if check_if_valid(wire, grid, direction, gates):
                    ...
                    if chip.calculate_cost_wirepart(location, first_direction) < chip.calculate_cost_wirepart(location, second_direction):
                    ...
                    print("not valid")
                    best_direction = location + first_direction

                print(first_direction, second_direction, best_direction)
