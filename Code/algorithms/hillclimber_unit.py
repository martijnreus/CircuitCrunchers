        ...
        while True:
            ...
            if distance.x != 0:
                ...
                if distance.y != 0:
                    ...
                    if chip.calculate_cost_wirepart(location_a, x_direction) >  chip.calculate_cost_wirepart(location_a, y_direction):
                    ...
                    if distance.z != 0:
                        ...
                        if chip.calculate_cost_wirepart(location_a, y_direction) > chip.calculate_cost_wirepart(location_a, z_direction) and chip.calculate_cost_wirepart(location_a, x_direction) >chip.calculate_cost_wirepart(location_a, z_direction):
                            wire.remove_wire_part()
                ...
                if distance.z != 0:
                    ...
                    z_direction = Location(0,0,1)
                    if chip.calculate_cost_wirepart(location_a, y_direction) >  chip.calculate_cost_wirepart(location_a, z_direction):
                        wire.remove_wire_part()
                        wire.add_wire_part(z_direction) 
